...
class TaxpayerAPI:
    ...
    def set(self, issuer_tax_number: str, issuer_legal_name: str, territory: str, metadata: Optional[Dict[str, Any]] = None) -> TaxpayerResponse:
        """
        ...
        :param metadata: Diccionario opcional con metadata adicional.
        ...
        return TaxpayerResponse.parse_obj(resp)
